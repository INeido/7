module.exports = {
  String: {
    ...
    label_wonder: { en: "Wonder", de: "Wunder", hu: "Csoda", ru: "", es: "Maravilla" },
    ...
    label_armada1: { en: "Harbour", de: "Hafen", hu: "Kikötő", ru: "", es: "Puerto" },
    ...
    calc_gear: { en: "Gear", de: "Zahnrad", hu: "Fogaskerék", ru: "", es: "Engranaje" },
    calc_tablet: { en: "Tablet", de: "Tablet", hu: "", ru: "", es: "Tableta" },
    calc_wildcard: {
      en: "Wildcard",
      de: "Platzhalter",
      hu: "Helyettesítő",
    ...
    browse_title: { en: "Game Browser", de: "Spielsuche", hu: "", ru: "", es: "Navegador de juegos" },
    browse_id: { en: "ID", de: "ID", hu: "", ru: "", es: "ID" },
    browse_locked: { en: "Locked", de: "Gesperrt", hu: "", ru: "", es: "Bloqueado" },
